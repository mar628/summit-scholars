...
import TeacherActions from './teachers/action';
import FeeActions from './fees/action';
import TeachingProgressActions from './teachingProgress/action';
...
export const myDetailsActions = { ...MyDetailsActions, clearMyDetailsErrorsAction, resetMyDetailsAction };
export const builderActions = { ...BuilderActions };
export const teacherActions = { ...TeacherActions };
export const feeActions = { ...FeeActions };
export const teachingProgressActions = { ...TeachingProgressActions };
