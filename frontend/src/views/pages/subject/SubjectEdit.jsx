...
const breadCrumbs = [
  ...
  { label: 'Subject Detail', href: null },
];
...
const SubjectEdit = () => {
  ...
  return (
    <MainWrapper breadCrumbs={breadCrumbs}>
      <MetaData title={`${publicSubjectDetail?.name || 'Chapter Details'} | Summit Scholars Hub`} />
            ...
            <Tabs defaultValue="chapters" className="w-full">
              ...
              <TabsContent value="grid">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {publicSubjectDetail?.chapters?.map((chapter) => (
                    <Card key={chapter?._id} className="overflow-hidden border-none shadow-md py-0">
...
export default memo(SubjectEdit);
