      ...
      <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0">
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-base font-bold text-[#1a3a6b]">Summit Scholars Hub</span>
            <span className="text-[10px] text-[#c9a227] italic font-medium hidden sm:block">Where Excellence Meets Elevation</span>
          </div>
        </div>
