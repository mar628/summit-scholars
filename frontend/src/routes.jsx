...
import MyBilling from './views/pages/billing/MyBilling';
import TeacherDashboard from './views/pages/teacher/TeacherDashboard';
import TeacherHomework from './views/pages/teacher/TeacherHomework';
import TeacherProgress from './views/pages/teacher/TeacherProgress';
import RegisterTeacher from './views/pages/teachers/RegisterTeacher';
...
import { ADMIN, STUDENT, TEACHER } from './constants/roles.constants';
...
const allRoutesMapper = [
  ...
  },
  {
    ...
    component: (
      <AuthWrapper roles={[ADMIN, STUDENT, TEACHER]}>
        <Setting />
      </AuthWrapper>
    ),
  },
  ...
  },
  {
    path: '/admin/notes',
    component: (
      <AuthWrapper roles={[ADMIN, TEACHER]}>
        <NotesList />
      </AuthWrapper>
    ),
  },
